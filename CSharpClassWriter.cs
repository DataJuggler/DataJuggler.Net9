...
namespace DataJuggler.NET9
{
	...
	{  
        ...
        private const string DelegatesReference = "DataJuggler.NET9.Delegates";
        private const string EnumerationsReference = "DataJuggler.NET9.Enumerations";
        #endregion
		...
		#region Methods
            ...
            #region CloneField(DataJuggler.NET9.DataField field,string newObjectName)
            public string CloneField(DataJuggler.NET9.DataField field,string newObjectName)
			{
                // local
                    ...
                    else
                    {
                        ...
                        switch (field.DataType)
				        {
					        ...
					        case DataManager.DataTypeEnum.DataTable:
						        ...
						        dataType =  "DataJuggler.NET9.DataTable";
			...
			#region CreateForEach(DataJuggler.NET9.DataTable table)
			/// <summary>
			/// This method creates a foreach for each field in the table
			/// </summary>
			/// <param name="table"></param>
			/// <returns></returns>
			public string CreateForEach(DataJuggler.NET9.DataTable table)
			{
            ...
            #region GetCompareLine(DataJuggler.NET9.DataTable table, string primaryKeyName)
            /// <summary>
            ...
            /// <returns></returns>
            public string GetCompareLine(DataJuggler.NET9.DataTable table, string primaryKeyName)
			{
			...
			public void InitializeStrings(List<DataField> fields)
			{
				...
				foreach(DataJuggler.NET9.DataField field in fields)
				{
			...
			#region LoadField(DataJuggler.NET9.DataField field)
			public string LoadField(DataJuggler.NET9.DataField Field)
			{
				// String Builder  
				StringBuilder sb = new StringBuilder("this.");
			...
			#region NullField(DataJuggler.NET9.DataField field)
			public string NullField(DataJuggler.NET9.DataField Field)
			{
				// Create StringBuilder
            ...
            #region ParseFieldValue(DataJuggler.NET9.DataField field)
            /// <summary>
            /// Parse the field value
            /// </summary>
            /// <param name="field"></param>
            /// <returns></returns>
            public string ParseFieldValue(DataJuggler.NET9.DataField field)
			{
				// Create StringBuilder Object
				StringBuilder sb = new StringBuilder();
			...
			#region SaveObject(DataJuggler.NET9.DataTable table)
			/// <summary>
			...
			/// <param name="table"></param>
			/// <returns></returns>
			public string SaveObject(DataJuggler.NET9.DataTable table)
			{
				// Create New Object Name
			...
			#region UpdateLine(DataJuggler.NET9.DataField field)
			public string UpdateLine(DataJuggler.NET9.DataField Field)
			{
			...
			private void WriteAddMethod(DataJuggler.NET9.DataTable table)
			{
			...
			{	
				// Write Each Class
				foreach(DataJuggler.NET9.DataTable table in tables)
				{
			...
			private void WriteConstructor(DataJuggler.NET9.DataTable table)
			{
			...
			#region WriteCreateTableMethod(DataJuggler.NET9.DataTable table)
			private void WriteCreateTableMethod(DataJuggler.NET9.DataTable table)
			{
				...
				// Write BeginRegion "CreateTable(DataJuggler.NET9.DataTable table)";
				line = "CreateTable(DataJuggler.NET9.DataTable table)";
				BeginRegion(line);

				// Write Method Name
				line = "private void CreateTable(DataJuggler.NET9.DataTable table)";
				WriteLine(line);
				...
				// Instanciate table
				line = "this.table = new DataJuggler.NET9.DataTable();";
				WriteLine(line);

				// Create field For Adding To Fields Collection
				line = "DataJuggler.NET9.DataField field = new DataJuggler.NET9.DataField();";
				WriteLine(line);
				...
				foreach(DataJuggler.NET9.DataField Field in table.ActiveFields)
				{
					// Write Blank Line
					WriteLine();
					...
					line = "field = new DataJuggler.NET9.DataField();";
					WriteLine(line);
			...
			#region WriteDataClassVariables(DataJuggler.NET9.DataTable table)
			private void WriteDataClassVariables(DataJuggler.NET9.DataTable table)
			{
				// local StringBuilder
				StringBuilder sb = new StringBuilder();
			...
			#region WriteDeleteChanges(DataJuggler.NET9.DataTable table)
			private void WriteDeleteChanges(DataJuggler.NET9.DataTable table)
			{
			...
			private void WriteExportToDataRowMethod(DataJuggler.NET9.DataTable dataTable)
			{
				...
				// Create row
				DataJuggler.NET9.DataRow dataRow = new DataRow(dataTable);
			...
			#region WriteGetIndex(DataJuggler.NET9.DataTable table)
			private void WriteGetIndex(DataJuggler.NET9.DataTable table)
			{
			...
			#region WriteInitialChanges(DataJuggler.NET9.DataTable table)
			private void WriteInitialChanges(DataJuggler.NET9.DataTable table)
			{
			...
			#region WriteLoadMethodFromDataRow(DataJuggler.NET9.DataTable table)
			private void WriteLoadMethodFromDataRow(DataJuggler.NET9.DataTable table)
			{
				// Local Variable
				string line = "";
			...
			#region WriteLoadMethods(DataJuggler.NET9.DataTable table)
			private void WriteLoadMethods(DataJuggler.NET9.DataTable table)
			{	
			...
			#region WriteMethods()
			private void WriteMethods(DataJuggler.NET9.DataTable table)
			{
				// Begin Region Constructor
				BeginRegion("Methods");
			...
			#region WriteProperties(DataJuggler.NET9.DataTable table) void
			private void WriteProperties(DataJuggler.NET9.DataTable table)
			{
			...
			public void WriteReferences(ReferencesSet references, bool requireDelegatesReference = false)
			{
                ...
                try
                {
                    ...
                    {  
                        ...
                        // if this reference name equals DataJuggler.NET9.Delegates
                        ...
                        // if this reference name equals DataJuggler.NET9.Enumerations
                    ...
                    if ((requireDelegatesReference) && (!hasDelegateReference))
                    {
                        ...
                        // write out the reference for DataJuggler.NET9.Delegates
                    ...
                    if ((requireDelegatesReference) && (!hasEnumerationsReference))
                    {
                        ...
                        // write out the reference for DataJuggler.NET9.Enumerations
                        WriteReference(referenceObject);
                    }
