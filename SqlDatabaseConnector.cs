...
namespace DataJuggler.NET9
{
    ...
    public class SQLDatabaseConnector
	{
		...
		#region Methods
			...
			#region BuildTableSQL(DataJuggler.NET9.DataTable dataTable)
			public string BuildTableSQL(DataJuggler.NET9.DataTable dataTable)
			{
                ...
                try
                {
                    ...
                    if (NullHelper.Exists(table))
                    {
                        ...
                        foreach (System.Data.DataRow databaseField in schemaTable.Rows)
                        {
                            ...
                            DataJuggler.NET9.DataField field = new DataField();
			...
			#region IsPrimaryKeyUpdateable(DataJuggler.NET9.DataTable table)
			/// <summary>
			...
			public bool IsPrimaryKeyUpdateable(DataJuggler.NET9.DataTable table)
			{
			...
			#region LoadDataRows() +1 overrides
				...
				#region LoadDataRows(DataJuggler.NET9.DataTable table)
				/// <summary>
				/// Loads All Rows For This table
				/// </summary>
				/// <param name="table"></param>
				/// <returns></returns>
				public List<DataRow> LoadDataRows(DataJuggler.NET9.DataTable dataTable)
				{
				...
				#region LoadDataRows(DataJuggler.NET9.DataTable table, string sql)
				/// <summary>
				...
				/// <param name="sql"></param>
				/// <returns></returns>
				public List<DataRow> LoadDataRows(DataJuggler.NET9.DataTable dataTable, string sql)
				{	
                ...
                public List<DataRow> LoadDataRowsWithoutBinaryData(DataTable dataTable, string sql = "")
                {
                    ...
                    try
                    {
                        ...
                        foreach (System.Data.DataRow tempDataRow in dataSet.Tables[dataTable.Name].Rows)
                        {
                            ...
                            // Create A New row
                            dataRow = new DataJuggler.NET9.DataRow(dataTable);

                            // Clone Fields Collection For This row
                            dataRow.Fields = CloneFields(dataTable.ActiveFields);

                            // Add Each field
                            foreach (DataJuggler.NET9.DataField field in dataTable.Fields)
                            {
            ...
            public List<DataTable> LoadDataTablesSchema(Database parentDatabase)
			{
				...
				{				
					...
					{	
						// Create A New table
						DataJuggler.NET9.DataTable dataTable = new DataJuggler.NET9.DataTable();
            ...
            public DataJuggler.NET9.DataTable LoadDataTableSchema(Database parentDatabase, string tableName)
            {
                // initial value
                ...
                try
                {
                    ...
                    {
                        // Create A New table
                        DataJuggler.NET9.DataTable dt = new DataJuggler.NET9.DataTable();
			...
			public List<StoredProcedure> LoadStoredProcedures(List<DataTable> tables)
			{
				...
				try
				{
					...
					foreach(System.Data.DataRow dr in ds.Tables["Procedures"].Rows)
					{
						...
						DataJuggler.NET9.StoredProcedure sp = new StoredProcedure();
