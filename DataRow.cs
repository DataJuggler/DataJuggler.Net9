...
namespace DataJuggler.NET9
{
	...
	public class DataRow
	{
		...
		private int index;
		private DataJuggler.NET9.DataTable parentTable;
		private string tag;
		#endregion
		...
		#region Constructor
			...
			#region DataRow(DataJuggler.NET9.DataTable ParentDataTable)
			public DataRow(DataJuggler.NET9.DataTable ParentDataTable)
			{
				// Set Parent table
		...
		#region Methods
			...
			#region PrimaryKey()
			public DataJuggler.NET9.DataField PrimaryKey()
			{
				// Create DataField 
				DataJuggler.NET9.DataField NoField = new DataField();
				NoField.FieldName = "void";

				// Search For PrimaryKey
				foreach(DataJuggler.NET9.DataField Field in this.Fields)
				{
		...
		#region Properties
			...
			#region ParentTable
			public DataJuggler.NET9.DataTable ParentTable
			{
				get
				{
					return parentTable;
